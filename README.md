...
## 🎨  Giao Diện UI/UX  (Premium Upgrades)


### 1. Hệ Màu sắc & Chủ Đề Đồng Bộ (Material Themes)
*   **Light Mode**: 
*   **Dark Mode (Obsidian Mode)**:
...
*   **Thẻ Cài Đặt Nhắc Nhở Thông Minh**: Hộp cài đặt thông báo bo góc `20px` với biểu tượng chuông đổi trạng thái phát sáng và nút gạt **Switch** tự động quét kiểm tra quyền hệ thống thực tế của thiết bị ảo ngay khi khởi động (`initState`)
